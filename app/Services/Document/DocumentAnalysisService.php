 ...
 *
 * Sends the document image (or PDF) to Anthropic's Claude claude-sonnet-4-6 model and parses
...
class DocumentAnalysisService
{
     ...
     * Sonnet offers the best balance of accuracy and cost for vision tasks.
     */
     ...
     * source so no public URL is required. Claude claude-sonnet-4-6 supports both image
